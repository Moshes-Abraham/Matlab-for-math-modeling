...
%  This is a file for providing a function of optimizing a function using GA algorithm. The codes below is for calculating the maximum value for a function with 2 variables. You can change the function imputs to (n,f) in oder to support more functions.
%  Inputs:    ...
%  Outputs:   ...
%  something else ...
